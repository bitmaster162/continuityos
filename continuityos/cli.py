...
def main(argv=None):
    ...
    im = s.add_parser("import", help="Import AI export (ChatGPT/Claude/Gemini/Grok/Mistral/Perplexity) -> memory")
    im.add_argument("path", help="export file or directory")
    im.add_argument("-n","--namespace",default="imported")
    im.add_argument("--source",default="auto",choices=["auto","chatgpt","claude","gemini","grok","mistral","perplexity"])
