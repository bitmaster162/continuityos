...
Nested help such as `continuity cold-start verify --help` remains owned by the existing safe/historical dispatch path and is not modified. That includes the R31 deterministic authority-root inspector and its `cold-start` subcommand help.
