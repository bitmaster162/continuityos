...
def prepare_trading_shadow_case(
    ...
    *,
    ...
    """Prepare SCT A/B/C inputs for a TradingOS case without writing to EvidenceStore."""
...
def export_sct_prediction(prediction: Any) -> dict[str, Any]:
    """Project one committed SCT-arm prediction into the TradingOS shadow packet contract."""
